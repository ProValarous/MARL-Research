...
def get_agents(
    ...
    agent_predator: Optional[BasePolicy] = None,
    ...
    agents = [agent_predator, agent_prey]
...
def train_agent(
    ...
    policy, optim, agents = get_agents(
        args, agent_prey=agent_prey, agent_predator=agent_predator, optim=optim
    )
...
def watch(
    ...
    policy, optim, agents = get_agents(
        args, agent_prey=agent_prey, agent_predator=agent_predator
    )
    policy.eval()
    policy.policies[agents[1]].set_eps(args.eps_test)
