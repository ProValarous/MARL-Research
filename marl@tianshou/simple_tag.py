...
env = simple_tag_v3.env(num_good=1, num_adversaries=3, num_obstacles=2, max_cycles=25, continuous_actions=False, render_mode="human")

env.reset(seed=42)

# Q_table = {agent: np.zeros((agent.observation_size, agent.action_size)) for agent in env.agents}
# print(Q_table)
